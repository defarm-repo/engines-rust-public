...
echo "STELLAR_TESTNET_RPC_FALLBACKS=https://soroban-rpc.testnet.stellar.gateway.fm,https://stellar-soroban-testnet-public.nodies.app"
...
echo "STELLAR_MAINNET_RPC_FALLBACKS=https://soroban-rpc.mainnet.stellar.org,https://soroban-rpc.mainnet.stellar.gateway.fm,https://stellar-soroban-public.nodies.app,https://stellar.api.onfinality.io/public,https://rpc.lightsail.network/,https://archive-rpc.lightsail.network/,https://mainnet.sorobanrpc.com"
...
echo "  • RPC fallbacks based on Stellar's public provider list (Nov 2025)"
echo ""
