...
# Comprehensive API Keys Testing Script - Bash 3.2 Compatible
...
function test_user() {
    ...
    echo "  → Testing X-API-Key header authentication..."
    ...
    # 4. Test API key authentication with Authorization: Bearer
    ...
    # 6. Test JWT still works (backward compatibility)
    echo "  → Testing JWT backward compatibility..."
    ...
    # 7. Test API key management endpoints
...
# Test all users
test_user "hen" "demo123" "Admin"
test_user "chick" "Demo123!" "Basic"
test_user "pullet" "demo123" "Professional"
test_user "cock" "demo123" "Enterprise"
...
if [ $FAILED_TESTS -eq 0 ]; then
    ...
    echo "✅ X-API-Key Header: WORKING"
    echo "✅ Authorization Bearer: WORKING"
